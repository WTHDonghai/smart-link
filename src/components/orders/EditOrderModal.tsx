  ...
  const footerContent = (
    <>
      ...
      <button
        ...
        className="px-4 py-2 bg-white border border-[#004ac6] text-[#004ac6] hover:bg-[#eff4ff] rounded-lg text-xs font-medium transition-colors cursor-pointer"
      >
        仅保存订单
      </button>
      ...
      <button
        ...
        className="px-5 py-2 bg-[#004ac6] hover:bg-[#003ea8] text-white rounded-lg text-xs font-medium transition-colors shadow-2xs cursor-pointer"
      >
        保存并导入
      </button>
    </>
        ...
        {/* Section 1: 订单信息 */}
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-8.5 px-3 bg-white border border-gray-300 rounded text-xs text-gray-900 focus:border-[#004ac6] outline-none"
                />
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <select
                  ...
                  className={`w-full h-8.5 px-2.5 bg-white border rounded text-xs text-gray-900 outline-none ${
                    hasValidated && !isRoomValid 
                      ...
                      : 'border-gray-300 focus:border-[#004ac6]'
                  }`}
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full h-8.5 px-2.5 bg-white border border-gray-300 rounded text-xs text-gray-900 focus:border-[#004ac6] outline-none"
                >
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full h-8.5 pl-3 pr-8 bg-white border border-gray-300 rounded text-xs text-gray-900 focus:border-[#004ac6] outline-none"
                  />
            ...
            <div className="flex items-center justify-between gap-4 py-2 border-b border-gray-100">
              ...
              <div className="w-44">
                <input
                  ...
                  className="w-full h-8.5 px-3 bg-white border border-gray-300 rounded text-xs text-right font-mono font-bold text-gray-900 focus:border-[#004ac6] outline-none"
                />
              </div>
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full p-3 bg-white border border-gray-300 rounded text-xs text-gray-900 focus:border-[#004ac6] outline-none leading-relaxed resize-none"
            />
          </div>
        </div>
      </Modal>
