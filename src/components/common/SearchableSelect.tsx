      ...
      >
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-2 gap-1 pointer-events-none">
          {clearable && value && (
            <span
              onClick={handleClear}
              className="pointer-events-auto text-[#a0aec0] hover:text-[#525f7f] cursor-pointer p-0.5"
            >
