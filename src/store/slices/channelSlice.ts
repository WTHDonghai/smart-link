...
export const ALL_CHANNELS_CATALOG: Omit<OTAChannel, 'todayOrders' | 'lastSyncTime'>[] = [
  {
    id: 'meituan',
    name: '美团',
    code: 'MEITUAN',
...
const initialState: ChannelState = {
  ...
  channels: [
    {
      ...ALL_CHANNELS_CATALOG[0],
      todayOrders: 428,
      lastSyncTime: '3秒前'
    },
    {
      ...ALL_CHANNELS_CATALOG[1],
      todayOrders: 215,
      lastSyncTime: '5秒前'
    },
    {
      ...ALL_CHANNELS_CATALOG[2],
      todayOrders: 362,
      lastSyncTime: '1秒前'
    }
  ]
  ...
  reducers: {
    addChannelById: (state, action: PayloadAction<string>) => {
      ...
      const newChannel: OTAChannel = {
        ...catalogItem,
        targetSystem: catalogItem.targetSystem || catalogItem.targetSystemOptions[0]?.val || `${catalogItem.id}_main`,
        todayOrders: 0,
        lastSyncTime: '刚刚初始化'
      };
